...
- **R7 Col E now authoritative (2026-03-13):** R7 FY24-25_Q4 values were re-scraped from actual `?duration=2025004` FY pages for all 38 grants, replacing the proxy values from 2026-03-12. The current values are authoritative (33/38 Complete, 5 Incomplete).
